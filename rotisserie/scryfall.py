...
def cards_named(cardname, fuzzy=False, api_endpoint='api.scryfall.com', scheme='https'):
    ...
    request_url = "{}://{}/cards/named?{}".format(
        scheme, api_endpoint, querystring)
